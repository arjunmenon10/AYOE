...
server <- function(input, output){
  ...
  qb_season %>% 
    ...
    geom_hline(yintercept = mean(passes_seasons$avg_ayoe), color = "black", linetype = "dashed", alpha=0.7)+
    geom_vline(xintercept =  mean(passes_seasons$EPA_play), color = "black", linetype = "dashed", alpha=0.7)+
